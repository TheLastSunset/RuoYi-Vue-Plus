...
public class GenConstants {
     ...
     * BO对象 不需要添加字段
     */
    public static final String[] COLUMN_NAME_NOT_ADD = {"create_by", "create_time", "del_flag", "update_by", "update_time", "version"};

    /**
     * BO对象 不需要编辑字段
     */
    public static final String[] COLUMN_NAME_NOT_EDIT = {"create_by", "create_time", "del_flag", "update_by", "update_time", "version"};

    /**
     * VO对象 不需要返回字段
     */
    public static final String[] COLUMN_NAME_NOT_LIST = {"create_by", "create_time", "del_flag", "update_by", "update_time", "version"};

    /**
     * BO对象 不需要查询字段
     */
    public static final String[] COLUMN_NAME_NOT_QUERY = {"id", "create_by", "create_time", "del_flag", "update_by", "update_time", "remark", "version"};
